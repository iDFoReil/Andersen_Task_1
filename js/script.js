...
buttonObj[1].addEventListener('click', addRecept);
buttonObj[2].addEventListener('click', checking);
...
function crElement(){
	...
	else{alert('Такой элемент уже существует или название не корректно');}
}
function addRecept(){
...
function checking(){
	...
	else{alert('Крафтить можно только из двух элементов')}
}
